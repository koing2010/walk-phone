...
#define OS_MAX_EVENTS             8    /* Max. number of event control blocks in your application ...  */
                                       /* ... MUST be > 0                                              */
#define OS_MAX_FLAGS              8    /* Max. number of Event Flag Groups    in your application ...  */
                                       /* ... MUST be > 0                                              */
#define OS_MAX_MEM_PART           8    /* Max. number of memory partitions ...                         */
                                       /* ... MUST be > 0                                              */
...
#define OS_TASK_STAT_STK_SIZE     150    /* Statistics task stack size (# of OS_STK wide entries)        */
